...
|--------------------------------------------------------------------------
|
| APP_LOCALE y APP_FALLBACK_LOCALE son "es", pero el framework solo trae "en".
| Sin este archivo, cualquier regla sin mensaje propio filtra su clave técnica
| al usuario final (p. ej. "validation.mimes").
|
*/
...
return [
    ...
    'uploaded' => 'No se pudo subir el archivo :attribute. Verifica su tamaño e inténtalo de nuevo.',
    ...
    */
    ...
    'custom' => [
        'file' => [
            'mimes' => 'El archivo debe ser un Excel (.xlsx o .xls).',
            'extensions' => 'El archivo debe ser de tipo: :values.',
