                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                pedirá un PIN seguro y aleatorio durante el inicio de
                                sesión, el cual puedes obtener de la aplicación
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                Este PIN puede obtenerse de una aplicación compatible
